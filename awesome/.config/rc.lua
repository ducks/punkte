...
beautiful.init(os.getenv("HOME") .. "/.config/awesome/themes/sasquatch/theme.lua")
beautiful.font              = "Anka/Coder Regular 10"
beautiful.notification_font = "Anka/Coder Bold 14"
...
vol_text = wibox.widget.textbox("Vol ")
...
local volume = lain.widget.pulse {
    ...
    settings = function()
        ...
        widget:set_markup(lain.util.markup("#27e0bb", vlevel))
    end
}
...
month_cal = awful.widget.calendar_popup.month()
month_cal:attach(mytextclock, 'br', { on_hover = false })

darkblue    = beautiful.bg_focus
mintgreen = "#27e0bb"
blue        = "#9EBABA"
red         = "#EB8F8F"
separator = wibox.widget.textbox(' <span color="' .. mintgreen .. '">| </span>')
spacer = wibox.widget.textbox(' <span color="' .. mintgreen .. '"> </span>')
...
local tagnames = beautiful.tagnames or { "1", "2", "3" }
